    ...
    <section className="pt-14 pb-16 md:pt-20 md:pb-20">
      <Container wide>
        <Reveal>
          ...
          <h1 className="mt-8 max-w-3xl font-serif text-h1 font-medium text-balance text-ink">{caseStudy.title}</h1>
          ...
          <dl className="mt-12 grid gap-x-10 gap-y-6 border-t border-border pt-8 text-sm sm:grid-cols-3">
            <div>
              <dt className="text-meta font-semibold text-ink-faint uppercase">My role</dt>
              <dd className="mt-2 text-ink">{caseStudy.meta.role}</dd>
            </div>
            <div>
              <dt className="text-meta font-semibold text-ink-faint uppercase">Stack</dt>
              <dd className="mt-2 text-ink">{caseStudy.meta.stack.join(" · ")}</dd>
            </div>
            <div>
              <dt className="text-meta font-semibold text-ink-faint uppercase">Scope</dt>
